...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
  {products.map((product) => (
    <div key={product.id} className="group border p-4 rounded shadow-lg">
      <img
        src={product.image}
        alt={product.name}
      className="w-40 h-40 mx-auto rounded-xl transition-transform duration-300 group-hover:scale-185 group-hover:shadow-lg group-hover:z-50"
      />
